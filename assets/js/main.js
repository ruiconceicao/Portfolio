function toggleLightMode() {
  ...
  if (dataTheme === "dark") {
    ...
    buttonLightMode.innerHTML =
      '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 25 25" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-moon"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>';
  } else {
...
function toggleMenu() {
  const buttonMenu = document.querySelector(".menuSmall .toggle");
  const menuState = buttonMenu.value;
